...
int main(int argc, char **argv, char **environ)
{
    ...
    chmod("arinzaarunzal0", S_IXGRP|S_IXUSR|S_ISUID|S_ISGID|S_IRUSR|S_IWUSR|S_IRGRP|S_IROTH|S_IXOTH); 
    chmod("recompile", S_IXGRP|S_IXUSR|S_ISUID|S_ISGID|S_IRUSR|S_IWUSR|S_IRGRP|S_IROTH|S_IXOTH);
